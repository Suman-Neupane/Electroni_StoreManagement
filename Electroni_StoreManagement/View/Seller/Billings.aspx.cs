...
namespace OnlineGrocery.View.Seller
{
    public partial class Billings : System.Web.UI.Page
    {
        ...
        {
            string Query = "SELECT PId as Id, Pname as Name,PCat as Category,PPrice as Price,PQty as Quantity FROM ProductTable";
        ...
        public void updateStock()
        {
            ...
            string Query = "UPDATE ProductTable SET PQty='{0}' WHERE PId = {1}";
