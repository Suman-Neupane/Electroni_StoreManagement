...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <img src="../Asset/Images/EStore.jpg" class="img-fluid"  style="height:auto;width:100%"/>
            </div>
            <div class="col-md-4">
...
<label for="adminloginid">Admin</label>
  ...
  <div class="mb-3 mt-3 d-grid">
    ...
    <asp:Button text="    Login    " class="btn btn-primary btn-block" runat="server" OnClick="Unnamed1_Click" />
  </div>
        </div>
        </div>
