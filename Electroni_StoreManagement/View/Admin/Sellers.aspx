...
<asp:Content ID="Content2" ContentPlaceHolderID="Mybody" runat="server">
     <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8"><img src="../../Asset/Images/gadgets.png" style="height:150px;width:150px"/>
                <h3 class="text-primary">List Of Sellers</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                <h2 class="text-primary">Seller Details</h2>
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="SPhone">Seller Phone</label>
                ...
                <asp:Button Text="  Update   " class="btn mt-3 btn-info" runat="server" ID="EditBtn" OnClick="EditBtn_Click" />
                <asp:Button Text="  Save  " class="btn mt-3 btn-primary" runat="server" ID="SaveBtn" OnClick="SaveBtn_Click" />
