...
namespace OnlineGrocery.View.Admin
{
    public partial class Products : System.Web.UI.Page
    {
        ...
        private void GetCategories()
        {
            ...
            CategoryCb.DataTextField = Conn.getData(Query).Columns["CName"].ToString();
            CategoryCb.DataValueField = Conn.getData(Query).Columns["CId"].ToString();
        ...
        protected void UpdateBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string Query = "UPDATE ProductTable SET PrName='{0}', PrCat={1}, PrPrice={2},PrQty={3},PrManDate='{4}' WHERE PrId = {5}";
